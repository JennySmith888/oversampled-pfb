...
################################################################
# This is a generated script based on design: os_pfb
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: os_pfb, and set properties
  set os_pfb [ create_bd_cell -type ip -vlnv xilinx.com:hls:os_pfb:1.0 os_pfb ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins os_pfb/in_r]
  ...
  connect_bd_intf_net -intf_net os_pfb_out_r [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins os_pfb/out_r]
