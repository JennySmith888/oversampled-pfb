...
HD_PWD='/home/jpsmith/git-repos/oversampled-pfb/vivado/myproj/project_1.runs/os_pfb_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log os_pfb_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source os_pfb_auto_ds_0.tcl
