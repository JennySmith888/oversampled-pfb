...
HD_PWD='/home/jpsmith/git-repos/oversampled-pfb/vivado/myproj/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log os_pfb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source os_pfb_wrapper.tcl -notrace
