...
HD_PWD='/home/jpsmith/git-repos/oversampled-pfb/vivado/myproj/project_1.runs/os_pfb_rst_ps8_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log os_pfb_rst_ps8_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source os_pfb_rst_ps8_0_99M_0.tcl
