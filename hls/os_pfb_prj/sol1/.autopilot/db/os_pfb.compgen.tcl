...
set InstName filter_out_channel_U
...
set InstName ifft_config_data_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 25
set FifoName fifo_w64_d1_A
set InstName ifft_out_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 26
set FifoName fifo_w8_d1_A
set InstName ifft_status_data_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 27
set FifoName start_for_fft_os_pfb_config_U0
set InstName start_for_fft_os_pfb_config_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 28
set FifoName start_for_be_U0
set InstName start_for_be_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { ovflow_TDATA { O 8 vector } ovflow_TVALID { O 1 bit } ovflow_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'ovflow'"
}
}
