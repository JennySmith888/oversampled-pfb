...
// ==============================================================
#ifndef __os_pfb_faddfsub_3g8j__HH__
#define __os_pfb_faddfsub_3g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(os_pfb_faddfsub_3g8j) {
    ...
    SC_CTOR(os_pfb_faddfsub_3g8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
