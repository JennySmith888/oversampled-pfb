# ==============================================================
# File generated on Fri Oct 25 14:59:04 PDT 2019
...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.os_pfb.autotvin_in_r.dat"
         "c.os_pfb.autotvin_out_data.dat"
         "c.os_pfb.autotvin_out_last_V.dat"
         "c.os_pfb.autotvin_ovflow.dat"
         "c.os_pfb.autotvout_out_data.dat"
         "c.os_pfb.autotvout_out_last_V.dat"
         "c.os_pfb.autotvout_ovflow.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.os_pfb.autotvout_out_data.dat"
         "rtl.os_pfb.autotvout_out_last_V.dat"
         "rtl.os_pfb.autotvout_ovflow.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
